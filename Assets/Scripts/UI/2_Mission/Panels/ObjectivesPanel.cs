...
public class ObjectivesPanel : MonoBehaviour
{
    ...
    private void UpdateAmount(ObjectiveEnum objectiveEnum, int value)
    {
        ...
        if (objective != null)
        {
            if (objectiveEnum is ObjectiveEnum.RestoreEcology or ObjectiveEnum.SurviveDays or ObjectiveEnum.CollectDataFragments or ObjectiveEnum.CollectIronIngots or ObjectiveEnum.CollectWood) objective.CurrentAmount = value;
