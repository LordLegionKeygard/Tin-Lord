...
public enum BulletEnum
{
    None = -1,
    Turret_Gun_Bullet = 0,
    Turret_BattleShipTower_Bullet = 1,
    Turret_Ballista_Bolt = 2,
    Turret_CannonBall = 3,
    Old_SniperRiffleBullet = 4,
    Turret_HowitzerBullet = 5,
    Turret_Rocket = 6,
    Old_RobotTankBullet = 7,
    Enemy_Beetle_Bullet = 8,
    Enemy_IceCrystal_Bullet = 9,
