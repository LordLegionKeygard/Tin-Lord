...
public class PlayerAttackState : PlayerState
{
    ...
    private bool IsTargetWithinAttackRange(PlayerStateChanger stateChanger, AttackInfo attack)
    {
    ...
    private bool CanPerformAttack(PlayerStateChanger stateChanger)
    {
        return stateChanger.CurrentAttackRecoveryTime <= 0 && stateChanger.CanAttack();
    }

    private void PerformAttack(PlayerStateChanger stateChanger, BaseAnimator animator)
    {
    ...
    private AttackInfo SelectNextAttack(PlayerAttacks attacks)
    {
