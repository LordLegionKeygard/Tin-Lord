...
public class MachineSpawnerSystem : MonoBehaviour
{
    ...
    public void LoadSpawnRobot(MissionSaveData missionSaveData)
    {
        ...
        _currentMachineSystem.SetNewRobot(_diContainer.InstantiatePrefab(_machinePrefabs[missionSaveData.MachineData.MachineType], spawnPosition, rotation, _parent), robotTypeEnum);
