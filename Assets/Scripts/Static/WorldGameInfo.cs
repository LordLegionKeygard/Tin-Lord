...
public class WorldGameInfo
{
    ...
    public const float EnemiesBigDetectionRadius = 100;
    ...
    public const int EarthQuakeChance = 60;
    ...
    public const float TutorialBaseConstructionSpeed = 20;
    ...
    public static int LanguageLength = 1300;
