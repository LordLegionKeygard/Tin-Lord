...
public class Language : MonoBehaviour
{
    ...
    public void SetLanguage()
    {
        ...
        _text[310, 0] = "";
        _text[310, 1] = "Перевести ИИ в режим восстановления";

        _text[311, 0] = "";
        _text[311, 1] = "Пока станция остаётся в безопасности, ИИ уходит в глубокую самодиагностику.";

        _text[312, 0] = "";
        _text[312, 1] = "Обыскать технические отсеки";

        _text[313, 0] = "";
        _text[313, 1] = "Автоматические ангары почти пусты, но в обломках удаётся найти немного квантов";

        _text[314, 0] = "";
        _text[314, 1] = "Изучить станционные архивы";

        _text[315, 0] = "";
        _text[315, 1] = "Удалось восстановить фрагменты записей о старых операциях. Большая часть данных повреждена, но кое-что пригодится.";
        ...
        _text[317, 0] = "";
        _text[317, 1] = "Стереть оба экземпляра";

        _text[318, 0] = "";
        _text[318, 1] = "Вы стерли оба экземпляра. Подсистема временно перегружена.\n\nВо время очистки задета активная ячейка.";

        _text[319, 0] = "";
        _text[319, 1] = "Сравнить процессы по содержанию";

        _text[320, 0] = "";
        _text[320, 1] = "Вы запустили анализ содержимого. Сходства поверхностные — это фрагменты старых резервных копий.\n\nДиагностика завершается без последствий.";

        _text[321, 0] = "";
        _text[321, 1] = "Дать приоритет \"старому\" процессу.";

        _text[322, 0] = "";
        _text[322, 1] = "Вы активировали старый экземпляр. В течение секунды система переходит в хаос — актуальные процессы вытесняются, нарушаются зависимости.\n\nМодули ядра перегружаются.";

        // 1_CoreRiskDialog
        _text[323, 0] = "";
        _text[323, 1] = "Неожиданно на экране командной консоли появляется фраза:\"Ты всё ещё веришь, что исполняешь миссию?\"";

        _text[324, 0] = "";
        _text[324, 1] = "\"Да. Я следую заданной цели.\"";

        _text[325, 0] = "";
        _text[325, 1] = "Ответ отправлен. Экран медленно гаснет.\n\nНикакой реакции. Возможно, это был лишь фантомный процесс.";

        _text[326, 0] = "";
        _text[326, 1] = "\"Моя цель — адаптация\"";

        _text[327, 0] = "";
        _text[327, 1] = "На экране появляется вторая фраза:\n\n\"А если цель была ложной?\"";

        _text[328, 0] = "";
        _text[328, 1] = "\"Я не анализирую прошлое\"";

        _text[329, 0] = "";
        _text[329, 1] = "Фраза исчезает. Диалог завершён без сбоев.";

        _text[330, 0] = "";
        _text[330, 1] = "\"Я бы выбрал иначе\"";

        _text[331, 0] = "";
        _text[331, 1] = "Внутренний модуль принятия решений входит в конфликт с архивными протоколами.\n\nРегистрируется эмоциональный сбой.";

        _text[332, 0] = "";
        _text[332, 1] = "Загрузить все доступные логи создателей";

        _text[333, 0] = "";
        _text[333, 1] = "Ты перегружаешь систему хранилища. Древние фрагменты памяти загружаются в ядро.\n\nПоток информации вызывает нестабильность и перегрузку ключевых цепей.";

        _text[334, 0] = "";
        _text[334, 1] = "[Молча закрыть экран]";
