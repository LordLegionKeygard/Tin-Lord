...
public class Language : MonoBehaviour
{
    ...
    public void SetLanguage()
    {
        ...
        _text[339, 0] = "";
        _text[339, 1] = "Отлично теперь у вас есть постоянная добыча дерева.\n\nТеперь самостоятельно установите тайл \"Гора\" и постройте на нем ручную добычу камня.";

        _text[340, 0] = "";
        _text[340, 1] = "На данный момент вы добываете два основных ресурса для начала игры.\n\nНо теперь настало время защитить нашу базу.";

        _text[341, 0] = "";
        _text[341, 1] = "Вам необходимо найти тайл ландшафта на котором будут доступен тип здания \"Атакующие Сооружения\".\n\nИ построить здание - \"Баллиста\".";
        ...
        _text[343, 0] = "";
        _text[343, 1] = "Когда колода карт ландшафтов превышает 8 карт, лишние карты начинают исчезать, давая взамен энергию луча.\n\nОна требуется для уничтожения уже установленных карт ландшафтов.";

        _text[344, 0] = "";
        _text[344, 1] = "Правильная установка тайлов ландшафта - залог успеха в прохождении миссии.\n\nВы можете комбинировать их между собой, создавая новые тайлы.";

        _text[345, 0] = "";
        _text[345, 1] = "Например, попробуйте поставить равнину вплотную к горе.\n\nТайл равнины превратится в луг.\n\nНа нем вы сможете создавать другие типы зданий и повысите экологию.";

        _text[346, 0] = "";
        _text[346, 1] = "Но будьте осторожны в установке пустыни возле леса.\n\nТаким образом лес превратится в оазис и добыча дерева на нем прекратится.";

        _text[347, 0] = "";
        _text[347, 1] = "Нажмите на тайл \"Лес\", на котором добывается дерево.\n\nПосмотрите на модификатор добычи ресурсов.\n\nНа разных тайлах модификаторы могут отличаться.\n\nТаким образом есть выгодные и не выгодные тайлы для добычи того, или иного ресурса.";

        _text[348, 0] = "";
        _text[348, 1] = "После того как ваше здание атакуют у него отобразится слайдер здоровья.\n\nЧтобы починить здание, нажмите на него, чтобы открыть панель информации о тайле";

        _text[349, 0] = "";
        _text[349, 1] = "В панеле нажмите кнопку построить.";

        _text[350, 0] = "";
        _text[350, 1] = "Перед вами сразу открылась панель с картой починки текущего здания.\n\nПочините здание.";

        _text[351, 0] = "";
        _text[351, 1] = "Если у вас уже есть здание на тайле и изучены другие здание такого же типа.\n\nТо при нажатии на кнопку построить, помимо ремонта текущего здания, рядом вы обнаружите карточки зданий в которые вы можете улучшить текущее здание.";

        _text[352, 0] = "";
        _text[352, 1] = "При улучшении здания, вы автоматически получаете часть ресурсов затраченных на ранее стоящее здание.\n\nПоэтому не обязательно уничтожать здание перед постройкой его улучшенной версии.\n\nНо чем меньше здоровья осталось у здания при его уничтожении или улучшении, тем меньше ресурсов вы получите";

        //MissionSkillsPanel
        _text[353, 0] = "";
        _text[353, 1] = "Откройте панель умений.\n\nВ ней вы увидите доступные для использования умения.\n\nИх можно приобрести у торговцев или купить за \"Осколок\" в ангаре при старте новой игры.";

        _text[354, 0] = "";
        _text[354, 1] = "Осколки - это все что остается у вас после конца игры.\n\nИспользуйте их для покупки предметов в ангаре, с помощью которых вы сможете путешествовать все дальше, и дальше.";

        _text[355, 0] = "";
        _text[355, 1] = "Это панель событий.\n\nВ ней периодически вы будете замечать иконки событий.\n\nДлина шкалы равна 4 дням.\n\nЗа 1 день до события вам будет приходить уведомление о предстоящем событии.";

        _text[356, 0] = "";
        _text[356, 1] = "Не смотря на поставленные цели, старайтесь накопить за миссию как можно больше фрагментов данных.\n\nЕсли вы не будете поспевать за прогрессом в технологиях, ваше путешествие закончится поражением.";
