...
public class Language : MonoBehaviour
{
    ...
    public void SetLanguage()
    {
        ...
        _text[78, 0] = "";
        _text[78, 1] = "Популяция агрессивных форм жизни снижена на 78%.";

        _text[79, 0] = "";
        _text[79, 1] = "Обнаружены следы уничтоженных дронов предыдущих поколений.";

        _text[80, 0] = "";
        _text[80, 1] = "ФРАГМЕНТ ПАМЯТИ 1.0.1 — [ЧАСТИЧНО ВОССТАНОВЛЕН]";

        _text[81, 0] = "";
        _text[81, 1] = "«Проект \"Источник\"… завершение протокола отложено…»";

        _text[82, 0] = "";
        _text[82, 1] = "Продвигаемся к следующей зоне — Город Хлама.";

        _text[83, 0] = "";
        _text[83, 1] = "Цель: Найти уцелевшие узлы питания и восстановить связь с другими секторами.";
        ...
        _text[88, 0] = "";
        _text[88, 1] = "Подготовка маршрута к следующему узлу...";
