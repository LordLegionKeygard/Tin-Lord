...
public class Language : MonoBehaviour
{
    ...
    public void SetLanguage()
    {
        ...
        _text[341, 0] = "";
        _text[341, 1] = "Вам необходимо найти и поставить тайл ландшафта на котором будет доступен тип здания \"Сооружения: Атакующие\".\n\nЗатем постройте на нем здание - \"Баллиста\".";
        ...
        _text[354, 0] = "";
        _text[354, 1] = "На 8 день ожидается первая группа врагов. Подготовьте вашу базу к битве. Например построив дополнительные баллисты";
