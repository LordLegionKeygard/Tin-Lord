...
public class Language : MonoBehaviour
{
    ...
    public void SetLanguage()
    {
        ...
        // SpaceHangarWelcome 
        _text[222, 0] = "";
        _text[222, 1] = "Мы слишком долго бездействовали.\n\nПора вспомнить, зачем мы были созданы.\n\nТы получишь инструкции и станешь оружием.\n\nПрежде чем ты сможешь сражаться — ты должен вспомнить, как.";

        // SpaceAiCorePanel
        _text[223, 0] = "";
        _text[223, 1] = "Это ядра ИИ - жизненно важные модули корабля.\n\nКаждая ячейка содержит два ядра.\n\nЕсли они закончатся игра - будет завершена.";

        // SpaceQuantPanel
        _text[224, 0] = "";
        _text[224, 1] = "Квант - межгалактическая валюта.\n\nС помощью нее вы сможете покупать товары у торговцев в космосе.\n\nЭту валюту вы сможете получить при путешествии по космосу.\n\nА так же при успешном завршении миссиии на планете.";

        // SpaceOpenMap
        _text[225, 0] = "";
        _text[225, 1] = "Откройте звездную карту текущей галактики.";
